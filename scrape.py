...
AZLYRICS_URL = 'http://www.azlyrics.com/g/guccimane.html'
CACHE_DIR = 'html/'
...
class LyricsWalker(object):
    ...
    def get_song_info(cls, url):
        ...
        try:
            album_info = soup.find('div', {'class': 'songinalbum_title'})
            if album_info:
    ...
    def walk_homepage(cls, home_url, output_dir=''):
        ...
        with open(filename, 'wb') as f:
            for song in song_lst:
                ...
                json.dump(cls.get_song_info(song_url), f, sort_keys=1, indent=2)
